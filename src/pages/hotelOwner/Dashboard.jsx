...
import { assets, dashboardDummyData } from '../../imp/images/assets'
 ...
 const [dashboardData,setDashboardData] = useState(dashboardDummyData)
  ...
  return (
    <div>
        ...
        Monitor your room listings ,track bookings and analyze revenue-all in one place. Stay updated with real-time insights to ensure operations.'/>
        <div className='flex gap-4 my-8'>
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
        <img src={assets.totalBookingIcon} alt='total booking' className='max-sm:hidden
        h-10'/>
