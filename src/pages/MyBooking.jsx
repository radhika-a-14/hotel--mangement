...
import { assets, userBookingsDummyData } from '../imp/images/assets'
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="max-w-6xl mt-8 w-full text-gray-800">
        {/* Table Header (visible only on md and above) */}
          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              <img
                ...
                alt="hotel-img"
                className="md:w-44 h-32 object-cover rounded-lg shadow"
              />
            ...
            {/* Date & Timing */}
            <div className="flex flex-row md:flex-col md:items-start md:justify-center gap-3 mt-4 md:mt-0">
              <div>
